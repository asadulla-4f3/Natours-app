...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXNhZHVsbGEtbmVtLXN0YWNrIiwiYSI6ImNsang3bXk2ZjBhdjgzZG53a21meXk2bXMifQ.eRUmIGMt9kWme9ykLh6zrg';
...
var passwordFormData = document.querySelector('.form-user-settings');
...
if (passwordFormData) {
  passwordFormData.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            newPasswordConfirm = document.getElementById('password-confirm').value; // data same as the API accepts
            _context2.next = 7;
